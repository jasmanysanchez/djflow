...
class Account(models.Model):
    ...
    Cuentas del usuario
    """
    created_by = models.ForeignKey(User, help_text=_("Usuario que ha creado la cuenta"), on_delete=models.PROTECT)
...
class Transaction(models.Model):
    ...
    created_by = models.ForeignKey(User, help_text=_("Usuario que ha creado la cuenta"), on_delete=models.PROTECT)
    account = models.ForeignKey(Account, help_text=_("Cuenta a afectar"), verbose_name=_("Cuenta"), on_delete=models.PROTECT)
    name = models.CharField(max_length=500, verbose_name=_("Descripción"))
    category = models.ForeignKey(Category, verbose_name=_("Categoría"), on_delete=models.PROTECT)
...
class TransactionComment(models.Model):
    transaction = models.ForeignKey(Transaction, verbose_name=_("Transacción"), on_delete=models.PROTECT)
    created_by = models.ForeignKey(User, verbose_name=_("Usuario"), on_delete=models.PROTECT)
